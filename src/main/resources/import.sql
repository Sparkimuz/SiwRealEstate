...
--insert into agent (id,real_estate_agency_id,name,surname,birthdate,url_image) values(nextval('agent_seq'),2,'Marco','Verdi','1982-11-02','/images/agents/marco.jpg');
--insert into agent (id,real_estate_agency_id,name,surname,birthdate,url_image) values(nextval('agent_seq'),2,'Francesca','Russo','1988-07-18','/images/agents/francesca.jpg');
--insert into agent (id,real_estate_agency_id,name,surname,birthdate,url_image) values(nextval('agent_seq'),3,'Antonio','Esposito','1980-02-01','/images/agents/antonio.jpg');
